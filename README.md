...
## Lite version
- `k3d cluster create k8sexample --volume $HOME/k8sexample:/var/lib/rancher/k3s/storage@all -s 1 --servers-memory 2Gb -a 1 --agents-memory 8gb --api-port 6443 -p 8081:80@loadbalancer`
