...
## Lite version
- `k3d cluster create k8sexample --volume $HOME/k8sexample:/var/lib/rancher/k3s/storage@all -s 1 --servers-memory 2Gb -a 3 --agents-memory 10gb --api-port 6443 -p 8081:80@loadbalancer -p 9089:9090@loadbalancer -p 8686:9000@loadbalancer`
