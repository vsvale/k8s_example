...
if __name__ == '__main__':
    ...
    spark = SparkSession \
            .builder \
            .appName("example-dimproductcategory-gold") \
    ...
    origin_folder = "s3a://lakehouse/silver/example/dimproductcategory/"
    destination_table = "public.dimproductcategory"
    jsonOptions = {"timestampFormat": "yyyy-MM-dd'T'HH:mm:ss.sss'Z'"}
    destination_folder = "s3a://lakehouse/gold/example/dimproductcategory/"
    ...
    dest_table_df = spark.createDataFrame(dest_table_df.rdd,schema=schemadimproductcategory)
    ...
    silver_df = spark.createDataFrame(silver_df.rdd,schema=schemadimproductcategory)
